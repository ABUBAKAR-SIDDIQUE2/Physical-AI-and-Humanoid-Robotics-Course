<!--
Sync Impact Report:
- Version Change: 1.0.0 -> 1.1.0 (Minor Revision: Updated folder naming conventions and governance details)
- Modified Principles: Section 12 (File & Folder Structure Rules), Governance (Version, Last Amended)
- Added Sections: None
...
<h2> 6. Ethical & Safety Guidelines
...
<h2> 8. AI Writing Protocol
<h3> Content Generation Rules
...
<h2> 9. Canon of the Book (Shared Definitions)
...
<h2> 10. Chapter Specification Requirements
...
<h2> 11. Frontmatter / Metadata Rules (for Docusaurus)
...
/docs/
  ...
  robotic-nervous-system-ros2/              (Weeks 3-5)
  digital-twin-gazebo-unity/        (Weeks 6-7)
  ai-robot-brain-nvidia-isaac/             (Weeks 8-10)
  humanoid-robot-development/         (Weeks 11-12)
  vision-language-action-vla/               (Module 4)
  conversational-robotics/    (Week 13)
  capstone-autonomous-humanoid/          (Final Project)
...
<h2> 13. Diagram Format Requirements
